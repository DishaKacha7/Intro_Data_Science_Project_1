...
us_flight_data<-read.csv("/Users/rachelculbreath/Desktop/International_Report_Departures_Project_1.csv")
str(us_flight_data)
```
...
## Top 5 Crriers with highest number of flights departing from US
