...
airplane = read.csv("DATASET/Airplane Accidents Severity.csv")
```
...
model <- multinom(Severity ~ Accident_Type_Code + Safety_Score + Control_Metric + Days_Since_Inspection, data = airplane)
