...
```
```{r vif, include=TRUE}
selected_variables <- airplane[, c("Safety_Score", "Days_Since_Inspection", "Control_Metric", "Accident_Type_Code", "Adverse_Weather_Metric")]

vif_result <- vif(lm(selected_variables))
