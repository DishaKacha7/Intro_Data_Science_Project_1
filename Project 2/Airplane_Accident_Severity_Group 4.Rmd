...
model <- multinom(Severity ~ Safety_Score + Days_Since_Inspection + Control_Metric + Turbulence_In_gforces + Accident_Type_Code  +Adverse_Weather_Metric , data = airplane)
